...
background-attachment: fixed; background-size: cover;">
    ...
    <div class="row0">
        <div class="slog">
            <h1>Create Timeless Melodies With A Classic Instrument!</h1>
            <p>Experience the enchantment of classical instruments and elevate your senses to a whole new level of musical delight.</p>
            <a href="#explore" class="btn ">Explore Now &#8594;</a>
        </div>
        <div class="slog">
            <img src="img/categ6.png"alt="">
        </div>
    </div>
    <!-- categories -->
    <div class="header-2">
    <div class="categories">
        ...
        <div class="row">
            <div class="col-2 rounded mx-auto d-block">
               <a href="#explore"><img src="img/guitar1.jpg" alt="" height="250px" ></a>
            </div>
            <div class="col-2 rounded mx-auto d-block">
                <a href="#piano"> <img src="img/piano1.jpg" alt="" height="250px" ></a>
            </div>
            <div class="col-2 rounded mx-auto d-block">
                <a href="#violin"> <img src="img/violin1.jpg" alt="" height="250px" ></a>
            </div>
        </div>
    </div>
    </div>
...
<div class="small-container">
    <h2 class="title" id="explore">Guitar Product</h2>
    ...
    <h2 class="title" id="piano">Piano Product</h2>
    <div class="rows1">
        <div class="cols">
